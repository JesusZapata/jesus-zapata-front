export class AddressService {
    ...
    getCurrentCountry() {
        return localStorage.getItem(stContent) ? localStorage.getItem(stContent).countryName : ENV.location[0].name;
    }
    ...
    submit(stContent, stLat, stLng, stAddressId, stAddress, stStoreType) {
        ...
        let currentCountry = this.getCurrentCountry(stContent);
